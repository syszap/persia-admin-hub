...
const EmptyTab = ({ title, ctaLabel, ctaIcon: Icon, emptyText }: { title: string; ctaLabel: string; ctaIcon: typeof Users; emptyText: string }) => (
    ...
    <AdminLayout>
      <div className="max-w-[1400px] mx-auto w-full">
        ...
        <Tabs defaultValue="general" dir="rtl" className="w-full">
          <div
            className="bg-card/80 backdrop-blur-sm rounded-2xl p-1.5 mb-8 border border-border/60"
          ...
          <TabsContent value="users">
            <EmptyTab title="لیست کاربران" ctaLabel="افزودن کاربر" ctaIcon={Users} emptyText="هنوز کاربری اضافه نشده است." />
          </TabsContent>
          <TabsContent value="roles">
            <EmptyTab title="ماتریس دسترسی‌ها" ctaLabel="افزودن نقش" ctaIcon={Shield} emptyText="هنوز نقشی تعریف نشده است." />
          </TabsContent>
          <TabsContent value="reports">
            <EmptyTab title="لیست گزارشات" ctaLabel="ساخت گزارش" ctaIcon={BarChart3} emptyText="هنوز گزارشی ساخته نشده است." />
          </TabsContent>
        </Tabs>
      </div>
      ...
      {/* Sticky save bar */}
      <div
        className="sticky bottom-0 inset-x-0 -mx-4 md:-mx-6 lg:-mx-8 -mb-4 md:-mb-6 lg:-mb-8 mt-8 bg-card/95 backdrop-blur-md border-t border-border/60 z-30"
